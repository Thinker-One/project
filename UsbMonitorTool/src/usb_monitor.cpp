...
std::shared_ptr<UsbDevice> UsbMonitor::parse_udev(struct udev_device *dev) {
    ...
    device.set_vendor_id(get(udev_device_get_sysattr_value(usb_dev, "idVendor")));
    device.set_product_id(get(udev_device_get_sysattr_value(usb_dev, "idProduct")));
    device.set_manufacturer(get(udev_device_get_sysattr_value(usb_dev, "manufacturer")));
    device.set_product(get(udev_device_get_sysattr_value(usb_dev, "product")));
    device.set_serial(get(udev_device_get_sysattr_value(usb_dev, "serial")));
